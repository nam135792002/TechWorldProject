...
function generateTrackCode(){
   ...
   htmlCode = `<div class="border rounded p-1" id="${rowId}">
          ...
          <div class="col-2">
            ...
            <div class="mt-1">
                <a class="linkRemoveTrack" href="" rowNumber="${nextCount}"><i class="bx bxs-trash" style="font-size: 30px; color: red"></i></a>
            </div>
          </div>
   ...
   htmlCode += `
              ...
              <div class="form-group row">
                ...
                <div class="col">
                  <textarea rows="2" cols="10" class="form-control" name="trackNotes" style="max-width: 300px" id="${trackNoteId}" required></textarea>
                </div>
              </div>
            </div>
        </div>
