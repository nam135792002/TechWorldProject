$(function() {
	...
	new ApexCharts(document.querySelector("#chart106"), e).render();
	e = {
		chart: {
			height: 180,
			type: "radialBar",
	...
	new ApexCharts(document.querySelector("#chart107"), e).render();
	e = {
		chart: {
			height: 180,
			type: "radialBar",
	...
	new ApexCharts(document.querySelector("#chart108"), e).render();
	e = {
		chart: {
			height: 180,
			type: "radialBar",
