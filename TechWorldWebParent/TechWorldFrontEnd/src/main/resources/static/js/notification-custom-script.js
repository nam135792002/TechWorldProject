...
function warning_noti(response) {
...
function success_noti(response) {
...
function pos4_error_noti(response) {
	Lobibox.notify('error', {
		pauseDelayOnHover: true,
		icon: 'bx bx-x-circle',
		size: 'mini',
...
function pos5_success_noti(response) {
	Lobibox.notify('success', {
		pauseDelayOnHover: true,
		size: 'mini',
		icon: 'bx bx-check-circle',
