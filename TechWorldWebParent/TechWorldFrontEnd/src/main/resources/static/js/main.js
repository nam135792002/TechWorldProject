(function(window, document, $, undefined) {
    ...
    var axilInit = {
        ...
        methods: function(e) {
            ...
            axilInit.countdownInit('.coming-countdown', '2023/11/01');
            axilInit.campaignCountdown('.campaign-countdown', '2023/11/01');
            axilInit.countdownInit('.poster-countdown', '2023/12/3');
            axilInit.countdownInit('.sale-countdown', '2023/11/31');
